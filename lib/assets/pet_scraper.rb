class PetScraper
  SPECIES = ["cat", "dog", "reptile", "smallfurry"]
  ...
  def self.scrape_and_populate
    finder = Petfinder::Client.new('bf43919be64d0ffed94aa9fa2acfd9d0', '11f2621e8fac20123e25a1807f0e61fe')

    finder.find_pets(SPECIES.sample, "NY", count: 50).each do |pf|
      ...
      pf_shelter = finder.shelter(pf.shelter_id)
